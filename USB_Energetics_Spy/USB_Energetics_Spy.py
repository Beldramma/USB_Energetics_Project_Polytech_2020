...
class OtherFrame(wx.Frame):
    ...
    def __init__(self, title, pathname, parent=None):
        ...
        pframe.plot(t, Data["voltage1"], panel=(0, 0), color='green')
        pframe.plot(t, Data["voltage2"], panel=(1, 0), color='yellow')
        pframe.plot(t, Data["current1"], panel=(0, 1), color='orange')
        pframe.plot(t, Data["current2"], panel=(1, 1), color='purple')
        pframe.plot(t, Data["power1"], panel=(0, 2), color='red')
        pframe.plot(t, Data["power2"], panel=(1, 2), color='black')
